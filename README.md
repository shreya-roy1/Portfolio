...
| Sector | Core Stack |
| :--- | :--- |
| **Frontend Platform** | React.js, Next.js, HTML5, CSS3, JavaScript (ES6+), TypeScript, Tailwind CSS, Bootstrap |
| **Backend Frameworks** | Node.js, Express.js, FastAPI, Python (Flask), Go (Golang), Java (JDBC) |
| **Database & Cloud Systems** | MySQL, PostgreSQL, MongoDB, Firebase (Firestore, Auth), Supabase |
| **Data Science & ML** | Python, TensorFlow, PyTorch, Scikit-learn, Pandas, NumPy, NLP |
| **Design & UI Architecture** | Figma, Tailwind UI, Framer Motion, Spline (3D), Adobe Suite |
| **Deployment & Git Ops** | Git, GitHub Actions, Docker, AWS (S3, EC2), Vercel, Render |
...
*   **Code**: [Employee Management Website](https://github.com/shreya-roy1/Employee_Management_system_Website)
*   **Demo**: [EMS Repository Source](https://github.com/shreya-roy1/Employee_Management_system_Website)
