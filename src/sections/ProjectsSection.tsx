  ...
  const projects: Project[] = [
    {
      ...
      name: 'AirDrawer',
      problem: 'Gesture drawing lags as webcam motion reaches the canvas.',
    ...
    },
    {
      ...
      impact: 'Kept encryption client-side and reduced exposure.',
    ...
    },
    {
      ...
      impact: 'Blocked phishing before unsafe navigation.',
    ...
    },
    {
      ...
      name: 'OmniShield',
      problem: 'Fraud signals are buried and hard to spot.',
      architecture: 'Dashboard visualizes telemetry and risk score simulations.',
      impact: 'Turned hidden fraud into visible investigation paths.',
    ...
    },
    {
      ...
      name: 'ArmorClaw',
      problem: 'Autonomous trading agents can act without validation.',
      architecture: 'Enforcement layer validates agent intents before trades.',
      impact: 'Reduced unauthorized execution and improved safety.',
